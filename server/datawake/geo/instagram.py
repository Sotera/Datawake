...
def doInstagramMagic(client_id, start_date, end_date, lat, lon):
...
def get(address):
    # streetAddress = '1600 Pennsylvania Ave, Washington, DC'
    resolvedAddress = getAddressLatLon(address)
    ...
    instagramJson = doInstagramMagic(client_id, sevenDaysEarlier, now, lat, lon)
    ...
    return json.dumps(resolvedAddress)
